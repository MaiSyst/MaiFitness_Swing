...
public class UsersModal extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        datePicker.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        ...
        passwordContainer.setMaximumSize(new java.awt.Dimension(356, 90));
        passwordContainer.setMinimumSize(new java.awt.Dimension(356, 90));
        passwordContainer.setOpaque(false);
        passwordContainer.setPreferredSize(new java.awt.Dimension(356, 90));
        ...
        passwordContainer1.setMaximumSize(new java.awt.Dimension(356, 90));
        passwordContainer1.setMinimumSize(new java.awt.Dimension(356, 90));
        passwordContainer1.setOpaque(false);
        passwordContainer1.setPreferredSize(new java.awt.Dimension(356, 90));

        jLabel10.setFont(new java.awt.Font("sansserif", 1, 18)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("Confirme mot de passe");

        confPassword.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        ...
        comboxRoomModel.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
