...
public class Constants {
    ...
    public static final String CUSTOMER_UPDATE_SUBSCRIPTION_URL_PATH = CUSTOMER_URL_PATH + "/updateSubscription";
    ...
    public static final String ROOM_FETCH_BY_ID_URL_PATH = ROOM_URL_PATH + "/fetchById";
    ...
    public static final String USER_UPDATE_PASSWORD_URL_PATH = USER_URL_PATH + "/updatePassword";
