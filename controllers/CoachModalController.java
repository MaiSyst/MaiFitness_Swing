...
public final class CoachModalController {
    ...
    private void addNewCoach() {
        ...
        var address = coachModal.getTxtAddress().getText().toLowerCase();
        ...
        if (firstName.isBlank() || lastName.isBlank()
            ...
            if (phone.length() == 11) {
                ...
                Notifications.getInstance().show(Notifications.Type.ERROR, Notifications.Location.TOP_RIGHT, "Verifier que le numéro est correctement saisi.");
            }
        }
    }
    ...
    private void editCoach(String coachId) {
        var firstName = coachModal.getTxtFirstname().getText().toLowerCase();
        var lastName = coachModal.getTxtLastname().getText().toLowerCase();
        var phone = coachModal.getPhoneNumber().getText();
        var address = coachModal.getTxtAddress().getText().toLowerCase();
        var activity = (ActivityModel) coachModal.getComboxActivity().getSelectedItem();
                ...
                if (status == ResponseStatusCode.OK) {
                    ...
                    if (sp == null) {
                        ...
                        models.forEach(model -> {
                            ...
                            if (model.label().toLowerCase().equals(sp.toLowerCase())) {
