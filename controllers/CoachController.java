...
public class CoachController implements MaiState {
    ...
    private void insertToDataTable(List<CoachModel> data) {
        ...
        if (isAdmin) {
            data.forEach(model
                ...
                model.coachId(),
                MaiUtils.toCapitalCase(model.firstName()),
                model.lastName().toUpperCase(),
                model.phone(),
                MaiUtils.toCapitalCase(model.address()),
                MaiUtils.toCapitalCase(model.speciality())
            })
            );
        } else {
            data.forEach(model
    ...
    private void showEditModal(
            ...
            String address,
            String speciality) {
        new CoachModalController(fetch, coachId, firstName.toLowerCase(), lastName.toLowerCase(),
                phone, address.toLowerCase(), speciality.toLowerCase(),
