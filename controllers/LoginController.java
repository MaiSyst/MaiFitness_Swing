...
public final class LoginController {
    ...
    private final JLabel msgInputText;
    private final JLabel msgInputPwd;
    private final JPanel loader;
    ...
    public LoginController(JFrame parent, JTextField username,
        ...
        checkBoxStayConnected.addItemListener(
                l -> isStayConnected = l.getStateChange() == ItemEvent.SELECTED);
                ...
                API.fetch().post("/auth/signIn", body).then((result, status) -> {
                    if (status == ResponseStatusCode.OK) {
                        ...
                        if (status == ResponseStatusCode.NOT_FOUND) {
                            ...
                            Notifications.getInstance().show(Notifications.Type.ERROR,3000, result);
                        }
                        loader.setVisible(false);
                    }
                });
